                ...
                <>
                    <div className='User-Profile' id='profile'>
                        <div className='Icon-Bg'>
                            <img src={Member[userId - 1].profile_picture} alt="" id='profile'/>
                        </div>
                        {Profile &&
                            <div className='DropdownMenu'>
                                <div className='Dropdown'>
                                    <Link to='/profile'>
                                        <img src={Member[userId - 1].profile_picture} alt={Member[userId - 1].username} />
                                        {` ${Member[userId - 1].first_name} ${Member[userId - 1].last_name} | @${Member[userId - 1].username}`}
                                    </Link>
                                    <hr/>
                                    <Link to='/settings'>
